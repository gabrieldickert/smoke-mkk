...
// Smoke MKK edit (F10): upstream's extra wrapper <div> around the template root (originally
// <main>) removed, so the classed element is the root and takes flex sizing from its parent.
